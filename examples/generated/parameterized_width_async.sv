module parameterized_width #(
    ...
    input logic [W-1:0] channel_A_receive_payload,
    output logic channel_B_send_request,
    input logic channel_B_send_acknowledge,
    output logic [W-1:0] channel_B_send_payload
);
  logic [W-1:0] body_var_0_value;
  logic input_0_body_req;
  logic input_0_body_ack;
  logic [W-1:0] receive_value_0;
  logic base_Lreq;
  logic base_Lack;
  logic base_raw_Rreq;
  logic base_Rack;
  logic storage_enable;
  logic [W-1:0] storage_0_data_in;
  logic [W-1:0] storage_0_data_out;
  ...
  assign storage_0_data_in = body_var_0_value;
  ...
  always_comb begin
    body_var_0_value = 'x;
    body_var_0_value = receive_value_0;
  end
